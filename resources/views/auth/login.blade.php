                    ...
                    <div class="auth-form-container text-start">
                        ...
                        <form class="auth-form login-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="email mb-3">
                                ...
                                <input id="signin-email" name="email" type="email" value="{{ old('email') }}" class="form-control signin-email @error('email') is-invalid @enderror" placeholder="Email address" required="required" autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <div class="password mb-3">
                                ...
                                <input id="signin-password" name="password" type="password" class="form-control signin-password @error('password') is-invalid @enderror" placeholder="Password" required="required" autocomplete="current-password">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
